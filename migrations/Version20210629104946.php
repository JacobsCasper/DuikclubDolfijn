 ...
 */
final class Version20210629104946 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE submition (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, phone_number VARCHAR(255) NOT NULL, shoe_size INT NOT NULL, experience VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_1CC2DC6DF85E0677 (username), UNIQUE INDEX UNIQ_1CC2DC6DE7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
