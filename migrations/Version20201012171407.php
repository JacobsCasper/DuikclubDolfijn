 ...
 */
final class Version20201012171407 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_3ABAEE21F08B48D3 ON web_form_string_type');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_3ABAEE21F08B48D3 ON web_form_string_type (Parent_id)');
    }
}
