 ...
 */
final class Version20200629190323 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE page ADD picture_path TINYTEXT NOT NULL, DROP nieuwsItem_id');
    }

    public function down(Schema $schema) : void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE page ADD nieuwsItem_id INT DEFAULT NULL, DROP picture_path');
